defmodule WidgetMarket do
   ...
   * elixir 1.12.3 (OTP 24) - trying to be up to date
   * phoenix 1.5.13 - again, going with the latest here
   * pow 1.0.25 - used for user authentication, registration
   * ecto_psql_extras 0.7.2 - to fulfill my live dashboard curiosity
